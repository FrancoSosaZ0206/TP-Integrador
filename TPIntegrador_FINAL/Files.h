...
PARÁMETROS:
    - centroLogistico: puntero a la estructura centro logístico.
...
DEVUELVE: puntero al centro logistico creado si TODO se abrió correctamente,
          NULL si ocurrió un error en la apertura DE ALGUNO DE LOS DATOS. */
...
/** OPERACIÓN: Función para leer líneas de texto terminadas con un caracter especial
PRECONDICIÓN:
