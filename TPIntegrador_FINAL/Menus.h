...
//OPERACIÓN: actualiza los datos de un reparto
//PRECONDICIÓN: centroLogistico debe haber sido creado en memoria dinamica
...
/// OPERACION: MENU
/// PRECONDICION: QUE EL PROGRAMA HAYA SIDO EJECUTADO
/// POSTCONDICION: PREGUNTA AL USUARIO SI DESEA
/// SEGUIR MODIFICANDO EL ELEMENTO ACTUAL
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA OPCION ELEGIDA
...
/// PRECONDICION: QUE EL PROGRAMA HAYA SIDO EJECUTADO
/// POSTCONDICION: PREGUNTA AL USUARIO SI DESEA
/// SI DESEA GUARDAR EN UN ARCHIVO LOS CAMBIOS REALIZADOS
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA OPCION ELEGIDA
int menuGuardarCambios();

/// OPERACION: MUESTRA
/// PRECONDICION: QUE ESCHOFER SEA BOOLEANO
/// POSTCONDICION: MUESTRA EL TIPO DE PERSONA
/// PARAMETROS: BOOLEANO
/// DEVUELVE: VACIO
void tipoPersona(bool esChofer);

/// OPERACION: NOTIFICACION
/// PRECONDICION: QUE LA LISTA HAYA SIDO CREADA EN MEMORIA DINAMICA
/// POSTCONDICION: AVISA SI LA LISTA ESTA VACIA
...
/// POSTCONDICION: MUESTRA POR PANTALLA LAS
///  POSIBLES FORMAS DE ORDENAR LOS PAQUETES
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA ELECCION
int menuTipoOrdenamientoPaquetes();

/// OPERACION: MENU
/// PRECONDICION: NINGUNO
/// POSTCONDICION: MUESTRA POR PANTALLA LAS
///  POSIBLES FORMAS DE ORDENAR LAS PERSONAS
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA ELECCION
...
/// PRECONDICION: NINGUNO
/// POSTCONDICION: MUESTRA POR PANTALLA LAS
///  POSIBLES FORMAS DE ORDENAR LOS VEHICULOS
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA ELECCION
...
/// PRECONDICION: NINGUNO
/// POSTCONDICION: MUESTRA POR PANTALLA LAS
///  POSIBLES FORMAS DE SELECCIONAR UN CAMPO DEL REPARTO
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA ELECCION
...
/// PRECONDICION: NINGUNO
/// POSTCONDICION: MUESTRA POR PANTALLA LAS
///  POSIBLES FORMAS DE MOSTRAR LOS REPARTOS
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA ELECCION
...
/// PRECONDICION: NINGUNO
/// POSTCONDICION: MUESTRA POR PANTALLA LAS
///  POSIBLES FORMAS DE ORDENAR LOS REPARTOS
/// PARAMETROS: NINGUNO
/// DEVUELVE: ENTERO REPRESENTANDO LA ELECCION
