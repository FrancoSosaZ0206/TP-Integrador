...
POSTCONDICION: MUESTRA UNA SERIE DE OPCIONES PARA MOSTRAR SEGUN
...
OPERACION: MENU
PRECONDICION: NINGUNA
POSTCONDICION: MUESTRA UNA SERIE DE OPCIONES PARA ELEGIR SEGUN
EL CAMPO SELECCIONADO
PARAMETROS: NINGUNO
DEVUELVE: ENTERO
**/
...
/**
OPERACION: GETTER
PRECONDICION: CENTRO LOGISTICO DEBE HABERSE CREADO EN MEMORIA DINAMICA
POSTCONDICION: BUSCA DENTRO DE LA LISTA DE REPARTOS LAS COINCIDENCIAS DE "ID" DE LOS PAQUETES
DENTRO DE LOS REPARTOS, SI ENCUENTRA EL REPARTO DEVUELVE UN PUNTERO A REPARTO
SINO DEVUELVE NULL
PARAMETROS:
            PUNTERO A CENTRO LOGISTICO
            ENTERO = ID DEL PAQUETE A BUSCAR
            BOOLEANO = LISTA DE REPARTOS A BUSCAR
DEVUELVE: PUNTERO A REPARTO O NULO
**/
...
OPERACION: GETTER
PRECONDICION: CENTRO LOGISTICO DEBE HABERSE CREADO EN MEMORIA DINAMICA
POSTCONDICION: BUSCA DENTRO DE LA LISTA DE REPARTOS LAS COINCIDENCIAS DE "FECHA DE SALIDA
O FECHA DE RETORNO" DENTRO DE LOS REPARTOS, SI ENCUENTRA EL REPARTO
DEVUELVE UN PUNTERO A REPARTO SINO DEVUELVE NULL
PARAMETROS:
            PUNTERO A CENTRO LOGISTICO
            PUNTERO A LA FECHA A BUSCAR
            BOOLEANO = LISTA DE REPARTOS A BUSCAR
DEVUELVE: PUNTERO A REPARTO O NULO
**/
...
OPERACION: GETTER
PRECONDICION: CENTRO LOGISTICO DEBE HABERSE CREADO EN MEMORIA DINAMICA
POSTCONDICION: BUSCA DENTRO DE LA LISTA DE REPARTOS LAS COINCIDENCIAS DE "PATENTE" DE VEHICULOS
DENTRO DE LOS REPARTOS, SI ENCUENTRA EL REPARTO DEVUELVE UN PUNTERO A REPARTO
SINO DEVUELVE NULL
PARAMETROS:
            PUNTERO A CENTRO LOGISTICO
            PUNTERO A CHAR = PATENTE DEL VEHICULO A BUSCAR
            BOOLEANO = LISTA DE REPARTOS A BUSCAR
DEVUELVE: PUNTERO A REPARTO O NULO
**/
...
OPERACION: GETTER
PRECONDICION: CENTRO LOGISTICO DEBE HABERSE CREADO EN MEMORIA DINAMICA
POSTCONDICION: BUSCA DENTRO DE LA LISTA DE REPARTOS LAS COINCIDENCIAS DE "CUIL" DE CHOFERES
DENTRO DE LOS REPARTOS, SI ENCUENTRA EL REPARTO DEVUELVE UN PUNTERO A REPARTO
SINO DEVUELVE NULL
PARAMETROS:
            PUNTERO A CENTRO LOGISTICO
            PUNTERO A CHAR = CUIL DEL CHOFER A BUSCAR
            BOOLEANO = LISTA DE REPARTOS A BUSCAR
DEVUELVE: PUNTERO A REPARTO O NULO
**/
...
OPERACION: GETTER
PRECONDICION: CENTRO LOGISTICO DEBE HABERSE CREADO EN MEMORIA DINAMICA
POSTCONDICION: MUESTRA UN MENU QUE PERMITE SELECCIONAR EL MODO DE BUSQUEDA
DE UN REPARTO, POR INDICE, POR CUIL DEL CHOFER, POR PATENTE DEL VEHICULO, POR
FECHA DE SALIDA, POR FECHA DE RETORNO, O POR ID DE ALGUN PAQUETE
PARAMETROS:
            PUNTERO A CENTRO LOGISTICO
            BOOLEANO = LISTA DE REPARTOS A BUSCAR
