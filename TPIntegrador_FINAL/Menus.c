...
void menuModificarCliente(CentroLogisticoPtr centroLogistico){
    ...
    if(iMod>0 && iMod<cantidadPersonas){
        PersonaPtr personaAModificar=(PersonaPtr)getDatoLista(getClientes(centroLogistico),iMod-1);
        do{
            system("cls");
            printf("Ha elegido - ");
...
void menuModificarChofer(CentroLogisticoPtr centroLogistico){
    ...
    scanf("%d",&iMod);
    if(iMod>0 && iMod<cantidadPersonas){
        PersonaPtr personaAModificar=(PersonaPtr)getDatoLista(getChoferes(centroLogistico),iMod-1);
        do{
            system("cls");
            printf("Ha elegido - ");
            mostrarPersona(personaAModificar);
