...
///POSTCONDICION: RETORNA EL REPARTO CON EL CAMPO ID IGUAL AL ID BUSCADO
///PARAMETROS:
...
///PRECONDICION: CENTRO LOGISTICO DEBE HABER SIDO CREADO EN
/// MEMORIA DINAMICA CON CREAR CENTRO LOGISTICO
///POSTCONDICION: RETORNA EL REPARTO CON EL CAMPO DIA,MES,ANIO,HORA,MINUTOS IGUAL AL DIA,MES,ANIO,HORA,MINUTOS BUSCADO
///PARAMETROS:
///         PUNTERO A CENTRO LOGISTICO
...
///PRECONDICION: CENTRO LOGISTICO DEBE HABER SIDO CREADO EN
/// MEMORIA DINAMICA CON CREAR CENTRO LOGISTICO
///POSTCONDICION: RETORNA EL REPARTO CON EL CAMPO PATENTE IGUAL AL PATENTE BUSCADO
///PARAMETROS:
///         PUNTERO A CENTRO LOGISTICO
...
///PRECONDICION: CENTRO LOGISTICO DEBE HABER SIDO CREADO EN
/// MEMORIA DINAMICA CON CREAR CENTRO LOGISTICO
///POSTCONDICION: RETORNA EL REPARTO CON EL CAMPO CUIL IGUAL AL CUIL BUSCADO EN REPARTOS
///PARAMETROS:
///         PUNTERO A CENTRO LOGISTICO
...
///PRECONDICION: CENTRO LOGISTICO DEBE HABER SIDO CREADO EN
/// MEMORIA DINAMICA CON CREAR CENTRO LOGISTICO
///POSTCONDICION: RETORNA LA PERSONA CON EL CAMPO CUIL IGUAL AL CUIL BUSCADO EN PERSONAS
///PARAMETROS:
///         PUNTERO A CENTRO LOGISTICO
///         PUNTERO A CHAR REPRESENTANDO EL CUIL A BUSCAR
...
///PRECONDICION: CENTRO LOGISTICO DEBE HABER SIDO CREADO EN
/// MEMORIA DINAMICA CON CREAR CENTRO LOGISTICO
///POSTCONDICION: RETORNA UN BOOLEANO EN FUNCION DE SI EXISTEN O
/// O NO CHOFERES DISPONIBLES
