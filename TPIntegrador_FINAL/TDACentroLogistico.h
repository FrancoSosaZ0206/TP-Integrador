...
///OPERACION: VERIFICACION
///PRECONDICION: CENTRO LOGISTICO DEBE HABER SIDO CREADO EN MEMORIA DINAMICA
///POSTCONDICION: VERIFICA 1 POR 1 TODOS LOS CUILS EXISTENTES, VERIFICANDO
/// QUE EL NUEVO GENERADO SEA REALMENTE UNICO
///PARAMETROS:
/// PUNTERO A CENTRO LOGISTICO
/// PUNTERO A CHAR DEL CUIL NUEVO
///DEVUELVE BOOLEANO (TRUE = UNICO / FALSE = NO UNICO)
...
RepartoPtr devolverRepartoFechaSalida(CentroLogisticoPtr centroLogistico, FechaPtr fechaBuscar, bool esRepartoAbierto, bool esFechaSalida);
