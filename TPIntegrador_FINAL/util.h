...
///POSTONDICION: MUESTRA EL TEXTO RECIBIDO CON CON \N\N AL PRINCIPIO
///SEGUIDOS DE UN === Y EL NUMERO ENTREGADO, FINALIZANDO CON \N\N
///TAMBIEN TIENE LIMPIAR BUFFER DE TECLADO POR SI ACASO,
///Y TAMBIEN TIENE UN SYSTEM("PAUSE"), PARA VER AQUELLO QUE SE IMPRIMIO
///PARAMETROS:
///         TEXTO A IMPRIMIR
///         ENTERO A IMPRIMIR
///DEVUELVE: VACIO
...
///PRECONDICION: NINGUNA
///POSTONDICION: MUESTRA EL TEXTO RECIBIDO CON CON \N\N AL PRINCIPIO
/// FINALIZANDO CON \N\N TAMBIEN TIENE LIMPIAR BUFFER DE TECLADO POR SI ACASO,
///Y TAMBIEN TIENE UN SYSTEM("PAUSE"), PARA VER AQUELLO QUE SE IMPRIMIO
///PARAMETROS:
///         TEXTO A IMPRIMIR
///DEVUELVE: VACIO
...
///OPERACION: MOSTRAR
///PRECONDICION: NINGUNA
///POSTONDICION: MUESTRA SI EL VALOR BOOLEANO ES VERDADERO O FALSO CON CON \N\N AL PRINCIPIO
/// FINALIZANDO CON \N\N TAMBIEN TIENE LIMPIAR BUFFER DE TECLADO POR SI ACASO,
///Y TAMBIEN TIENE UN SYSTEM("PAUSE"), PARA VER AQUELLO QUE SE IMPRIMIO
///PARAMETROS:
