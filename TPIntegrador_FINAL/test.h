...
///OPERACION: ESCRITURA
///PRECONDICION: NINGUNA, ES DE TESTEO
///POSTCONDICION: MUESTRA EL RESULTADO FINAL DE LAS OPERACIONES
/// DE GUARDADP, TRUE = GUARDARON CORRECTAMENTE
/// FALSE = NO GUARDARON CORRECTAMENTE
///PARAMETROS: NINGUNO (SE PRODUCEN DENTRO DE LA FUNCION)
///DEVUELVE: VACIO [MUESTRA INTERNAMENTE POR PANTALLA EL RESULTADO]
void probarGuardado();
...
///OPERACION: CREACION
///PRECONDICION: LOS ELEMENTOS DEBEN SER CREADOS EN MEMORIA DINAMICA
///POSTCONDICION: CREA UNA LISTA CON LA ESTRUCTURA CENTRO LOGISTICO EN MEMORIA DINAMICA
///PARAMETROS: NINGUNO [SE CREAN Y DECLARAN DENTRO DE LA FUNCION]
///DEVUELVE: PUNTERO A LA LISTA CREADA CON DATOS GENERICOS DE CENTRO LOGISTICO
CentroLogisticoPtr crearCentroLogisticoDefecto();

///OPERACION: VERIFICACION
///PRECONDICION: LOS ELEMENTOS DEBEN SER CREADOS EN MEMORIA DINAMICA
///POSTCONDICION: CREA UNA LISTA CON LA ESTRUCTURA CENTRO LOGISTICO EN MEMORIA DINAMICA
/// LA GUARDA EN UN ARCHIVO, Y LUEGO LO ABRE
///PARAMETROS: NINGUNO [SE CREAN Y DECLARAN DENTRO DE LA FUNCION]
///DEVUELVE: VACIO
void probandoAmbos();
